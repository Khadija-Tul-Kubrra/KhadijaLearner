...
public class FareCalculator {
    ...
    public FareCalculator () {
        ...
        departLabel = new JLabel("Departure Provinces: ");
        departCombo = new JComboBox();
        departCombo.addItem("Punjab-Lahore");
        departCombo.addItem("KPK-Peshawar");
        ...
        arrLabel = new JLabel("Arrival Provinces: ");
        arrCombo = new JComboBox();
        arrCombo.addItem("Islamabad-Islamabad");
        arrCombo.addItem("Punjab-Gujranwala");
        arrCombo.addItem("Punjab-Faisalabad");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if (seatText.getText().equals("")) {
                        ...
                        if (departCombo.getSelectedItem() == "Punjab-Lahore" ) {
                            if (arrCombo.getSelectedItem() == "Islamabad-Islamabad") {
                                eco = 500;
                                acClass = 1000;
                            ...
                            else if (arrCombo.getSelectedItem() == "Punjab-Gujranwala") {
                                eco = 600;
                                acClass = 1500;
                                if (economy.isSelected()) {
                                    totalFareText.setText(String.format("%d", eco*seatNum));
                            ...
                            else if (arrCombo.getSelectedItem() == "Punjab-Faisalabad") {
                                eco = 700;
                                acClass = 200;
                                if (economy.isSelected()) {
                                    totalFareText.setText(String.format("%d", eco*seatNum));
                        ...
                        else if (departCombo.getSelectedItem() == "KPK-Peshawar" ) {
